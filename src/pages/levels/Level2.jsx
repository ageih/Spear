...
//                       Level {user.cs_user_level}
//                     </span>
//                     <span className="member-dept">
//                       {user.cs_user_department}
//                     </span>
//                   </div>
//                 </div>
//               ))}
...
function Level2({ currentUser }) {
  ...
  // In Level1.jsx - FIXED VERSION
  useEffect(() => {
    const fetchSummary = async () => {
      try {
        // ✅ GET SESSION ID FROM TICKETSESSION
        const ticketSession = localStorage.getItem("ticketSession");
        console.log("📦 Full ticketSession:", ticketSession);
        ...
        const sessionId = parsedTicket.sessionId; // ← Get from here!

        console.log("🔐 Session ID from ticketSession:", sessionId);

        if (!sessionId) {
          console.error("❌ No session ID found in ticketSession!");
          return;
        }
